...
X|Data entry is via the command line (unless you want to create a panel for data entry and display)
 ...
 |Calculator must support higher precedence for multiplication and division than addition and subtraction (parenthetical support could be added for extra credit)
